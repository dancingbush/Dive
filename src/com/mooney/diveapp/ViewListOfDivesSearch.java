...
public class ViewListOfDivesSearch extends ListActivity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener{
	 ...
	 * Otherwise use class ViewListDoves
	 * 
	 */
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		/*
		 * by assigning the row number here we keep sending row 7 (alcohol) to SeleectedTest, not sure why
...
*/
	...
	public void onBackPressed() {
		...
		finish(); // call sonDestroy freeing all resources
System.gc();
	}
