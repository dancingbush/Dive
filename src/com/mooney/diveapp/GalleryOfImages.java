...
public getArrayListFromAyschTask bitmapArrays;//type interface
   ...
   public void onCreate(Bundle savedInstanceState) 
   {
        ...
        */
     		...
     		// handle back button and share biutton on top of screen
       backAndShareTextViews();
   ...
   private void backAndShareTextViews() {
	// code from mini app gallery uisng shared intent to handle all
	   // regsitering, certofocates etc and 
	   // dispalys a list fo options to share ie twitter, facebook, email etc
	   ...
	   // Menu back click
		...
		// handle the shared intent passing the image in gallery
		
		TextView menu_share= (TextView) findViewById(R.id.top_share);
		menu_share.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*
				 * Usr wallPaperBitmap ref to get image to share, this is also in onCLick
				 * Stor bitmap selected in cache dir of ext storage
				 * Then send as URi intent
				 * 
				 * 
				 */
...
//inner itemadapter class
   public class GalleryImageAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// set the global var Bitmap that can be used with share button
		shareImage = bitmapArray.get(position);
   ...
   //inner class to return bitmap from DB image off the main thread
...
public void onBackPressed() {
	// free resiurces and call finish) which will detroy activity
